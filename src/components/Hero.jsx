...
export default function Hero({ onOpenQuote }) {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 w-80 h-80 bg-[#F3D379]/10 rounded-full blur-3xl pointer-events-none"></div>

      {/* Animated Subtle Gold Frame Geometry Lines */}
      <div className="absolute inset-x-8 top-32 bottom-12 border border-[#D4AF37]/10 pointer-events-none rounded-2xl hidden lg:block">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#171717]/90 border border-[#D4AF37]/30 backdrop-blur-md mb-6 shadow-gold-glow"
          >
            <Sparkles className="w-4 h-4 text-[#F3D379] animate-pulse" />
            <span className="text-xs sm:text-xs font-semibold text-[#F3D379] tracking-widest uppercase">
              {HERO_DATA.eyebrow}
            </span>
          </motion.div>
          ...
          >
            ...
            <a
              ...
              className="px-7 py-4 rounded-xl bg-gradient-to-r from-[#F3D379] via-[#D4AF37] to-[#9A7B39] text-black font-display font-bold text-sm tracking-wider uppercase flex items-center gap-3 shadow-gold-glow hover:shadow-gold-glow-lg hover:scale-[1.02] transition-all duration-300"
            >
            ...
            <button
              onClick={onOpenQuote}
              className="px-7 py-4 rounded-xl bg-[#171717] border border-[#D4AF37]/40 text-[#F3D379] font-display font-semibold text-sm tracking-wider uppercase hover:border-[#D4AF37] hover:bg-[#222222] transition-all duration-300"
            >
              Get a Free Quote
            </button>
